...
const Projects = () => {
  return (
    <div className="min-h-screen bg-black text-white -mt-2 px-4 py-10"> 
      <div className="max-w-6xl mx-auto"> 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
          {/* Project 1 */}
          <div className="bg-purple-960 p-6 rounded-2xl border border-purple-900 w-full max-w-md hover:scale-105 transition-transform duration-300"> 
            <div className="w-full h-40 mb-4 overflow-hidden flex justify-center items-center"> 
              <img 
                src={ProjectImage1} 
                alt="Project 1" 
